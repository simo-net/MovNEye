...
from visionart.motion.ptu import PTU
from visionart.motion.ptu import find_ptuport, deg2pos, pos2deg
# 3) Image display package (for stimulation)
from visionart.utils.add2cv import get_multi_screen_geometry, adapt_img2screen
from visionart.functional.store import store_json, update_json
...
class RecordImage(RecordScene):
    ...
    def __init__(self,
                 ...
                 reset_timestamps: bool = True,
                 # 2) Stimulus info
                 img_file: str = None, img: np.ndarray = None,
    ...
    def img(self, img: np.ndarray):
        self._img = self._adapt_img2screen(img)
