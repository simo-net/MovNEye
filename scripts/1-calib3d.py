...
from movneye.calib.chess import chess4screen
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='In this script we do 4 main things:\n'
                    ...
                    '     on the monitor and use the results to compute the camera-monitor homography transformation.\n'
                    ...
                    '     Homography results (rotation and translation vectors between sensor and monitor) are stored\n'
                    f'     as .npy files in {CALIB3D_RESULT_DIR}.\n'
