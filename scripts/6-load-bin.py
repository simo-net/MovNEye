...
from movneye.sensor import dvs
from movneye.functional.wrap import read_bin
from movneye.opening import load_img_dataset
...
def load_bin_recording(file2load: str,
    ...
    img = load_img_dataset(dataset_type, split=img_split, index=int(img_id), verbose=verbose, plot=False)
