...
# Usage:
# >>    python3 2-fems.py  --fem_dir ./data/fem  --verbose  --n_burnin 16000  --ask_feedback
# ...or...
# >>    python3 2-fems.py  --fem_dir ./data/fem  --verbose  --n_burnin 6000   --ask_feedback
#                          --foveola 60  --lamda 0.1  --hc 2.3


def parse_args():
    parser = argparse.ArgumentParser(
        description='Generating and saving FEM sequences according to the Self-Avoiding random Walk (SAW) model.')
