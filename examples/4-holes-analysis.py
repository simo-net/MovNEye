...
from visionart.functional.diagnose import detect_holes_distribution
from visionart.utils.add2os import keep_list_extension, listdir_flatten


# Usage:
# >>    python3 4-holes-analysis.py  --rec_dir ./data/rec  --store_results
#                                     --max_num_holes 1  --max_hole_duration 6
