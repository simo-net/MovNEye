...
from visionart.calib.calib3d import continuous_image_roi_search

# Usage:
# >>    python3 1-calib3d-till-break.py  --screen_resolution 1920 1080  --screen_diagonal 24
...
if __name__ == "__main__":
    ...
    #       'Define the chessboard stimulus '
    #       '====================================')
    # chess.chess4screen(resolution=tuple(args.screen_resolution), diagonal=args.screen_diagonal,     # monitor info
    ...
    # print(f'The monitor is at a distance of {round(monitor_distance(), 1)} cm.')
    ...
    #     roi = loader.compute_roi_from_bounds(img_bounds)  # [[top_left[x,y]], [bottom_right[x,y]]]
    ...
    #                                                                     show_results=True)
    #         roi = loader.compute_roi_from_bounds(img_bounds_with_margin)  # [[top_left[x,y]], [bottom_right[x,y]]]
