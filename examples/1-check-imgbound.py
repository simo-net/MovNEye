...
from visionart.motion.ptu import find_ptuport, PTU

# Usage:
#       python3 1-check-imgbound.py  --img_border 0.86  --img_resolution 28 28  --img_margin 1
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Find the 4 pixel coordinates, on the camera plane, corresponding to the 4 corners of the image '
                    'on the monitor.')
